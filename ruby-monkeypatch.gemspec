...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "lib/monkeypatch.rb", "lib/monkeywarn.rb", "test/test_monkeypatch.rb", "task/gem.rake", "task/rcov.rake", "task/rdoc.rake", "task/test.rake", "example/patch_usage.rb"]
  s.has_rdoc = true
